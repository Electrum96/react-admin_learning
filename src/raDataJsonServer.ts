...
import { Unit_QueueList } from "component/Unit_Queue";
import { Tableau_VwList } from "component/TableauVw";
...
const mapKeysByResource: any = {
  ...
  Worker: "Worker_Id",
  OrderQueue4Unit: "Order_Queue_Id",
  NextWorker: "Worker_Id",
  Queue2Tableau: "Nn_4_Tableau",
  AU_Users: "Usr_Id",
  Order_4_Q: "Order_Id",
  Order_Q_Log: "Log_Id",
  Places: "Place_Id",
  Unit: "Unit_Id",
  Unit_All: "Unit_Id",
  Place2Woker_4_Usr_IdGetList: "Rowid",
  Worker_All: "Worker_Id",
  MessageQueueLog: "Rowid",
  MessageQueueDet: "Rowid",
  MessageTemplatesEntry: "Config_Id",
  Admin_Worker_Hierarchy: "Level_Id",
  Daughter_Worker_Hierarchy: "Level_Id",
  UnitRole_Config: "Rowid",
  Unit_Queue: "Unit_Queue_Id",
  Linked_Unit_Queue: "Rowid",
  Tableau_Vw: "Worker_Id",
  Tableau_Users: "Login",
  Named_Unit_List: "List_Id",
  Named_List_Member: "Rowid",
  Message_Queue_4_Link: "Link_Unit_Queue_Id",
  Tableau_Worker: "Rowid"
};
